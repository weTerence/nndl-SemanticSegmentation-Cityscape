...
def parse_args():
    ...
    ##
    parser.add_argument('--boardlog-dir', default='../runs/boardlogs/',
                        help='Directory for saving checkpoint models')
    ##
...
class Trainer(object):
    ...
    def train(self):
        ...
        #### tensorborad: save to the file
        writer = SummaryWriter('../runs/boardlogs/')
        ####
        ...
        for iteration, (images, targets, _) in enumerate(self.train_loader):
            ...
            ###### tensorboard
            writer.add_scalar("trainloss", losses_reduced.item(), iteration)
            ######
            ...
            if not self.args.skip_val and iteration % val_per_iters == 0:
                mean_pixACC,mean_mIoU = self.validation()

                ###### tensorboard
                writer.add_scalar("validpixACC", mean_pixACC, iteration)
                writer.add_scalar("validmIoU", mean_mIoU, iteration)
                ###### tensorboard
...
if __name__ == '__main__':
    ...
    # writer = SummaryWriter('../runs/boardlogs/')  # 数据存放在这个文件夹

...
def get_fcn32s(dataset='citys', backbone='vgg16', pretrained=False, root='~/.torch/models',
    ...
    if pretrained:
        ...
        #                       map_location=device))
        model.load_state_dict(torch.load('/home2/HWGroup/jinjh/.torch/models/fcn32s_vgg16_citys_best_model.pth'))
    return model
